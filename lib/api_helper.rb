...
module ApiHelper
  ...
  SIGNATURE_MAP =
  {
    ...
    :photo_detail   => { :accepts => [:photo_id],
                         ...
                         :fonts => [:id, :user_id, :family_unique_id, :family_name, :family_id, :subfont_name, :subfont_id, :tags_count, :agrees_count, :my_agree_status, :pick_status, :my_fav?],
                         :hash_tags => [:name] },
    ...
    :font_photos    => { :accepts => [:family_unique_id, :subfont_id],
                         :returns => [:id, :url_thumb] },

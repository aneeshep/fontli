...
module ApiHelper
  ...
  SIGNATURE_MAP =
  {
    ...
    :collection_detail   => { :accepts     => [:collection_id],
                              ...
                              :fotos       => [:id, :user_id, :caption, :created_dt, :url_large, :username, :user_url_thumb,
                                               :permalink, :likes_count, :fonts_count, :comments_count, :fonts_ord,
                                               :address, :latitude, :longitude, :font_help, :liked?, :commented?,
                                               :liked_user, :commented_user, :collections],
                              :collections => [:id, :name, :can_follow?],
                              :fonts_ord   => [:user_id, :family_unique_id, :family_name, :family_id,
                                               :subfont_name, :subfont_id, :tags_count, :agrees_count,
                                               :pick_status, :img_url, :my_fav?, :expert_tagged] },
    :add_photo_to_collections => { :accepts => [:photo_id, :collection_names],
                                   :returns => true },

    :upload_data    => { :accepts => [:data],
                         :returns => [:id] },
    :publish_photo  => { :accepts => [:photo_id, :caption, [:latitude, :longitude, :address, :font_help, :font_tags, :hashes, :collection_names]],
    ...
    :photo_detail   => { :accepts     => [:photo_id],
                         :returns     => [:id, :user_id, :caption, :created_dt, :url_large, :user_url_thumb, :username,
                                          :permalink, :likes_count, :fonts_count, :comments_count, :fonts_ord,
                                          :address, :latitude, :longitude, :liked?, :commented?, :liked_user, :commented_user,
                                          :font_help, :hash_tags, :collections],
                         :fonts_ord   => [:id, :user_id, :family_unique_id, :family_name, :family_id, :subfont_name, :subfont_id,
                                          :img_url, :tags_count, :agrees_count, :my_agree_status, :pick_status, :my_fav?, :expert_tagged],
                         :collections => [:id, :name, :can_follow?],
                         :hash_tags   => [:name] },
    ...
    :hash_tag_feeds => { :accepts => [:name, [:page, :recent]],
                         :returns => [:id, :user_id, :caption, :created_dt, :url_large, :username, :user_url_thumb, :permalink,
                                      :likes_count, :fonts_count, :comments_count, :fonts_ord, :address, :latitude, :longitude,
                                      :font_help, :liked?, :commented?, :liked_user, :commented_user],
                         :fonts_ord => [:user_id, :family_unique_id, :family_name, :family_id, :subfont_name, :subfont_id, :tags_count,
                                        :agrees_count, :pick_status, :img_url, :my_fav?, :expert_tagged] },
    :leaderboard    => { :accepts => [],
                         :returns => [:id, :username, :full_name, :points, :url_thumb, :photos_count,
    ...
    :my_feeds       => { :accepts => [[:page]],
                         :returns => [:id, :user_id, :caption, :created_dt, :url_large, :username, :user_url_thumb, :permalink,
                                      :likes_count, :fonts_count, :comments_count, :fonts_ord, :address, :latitude, :longitude,
                                      :font_help, :liked?, :commented?, :liked_user, :commented_user, :collections],
                         :collections => [:id, :name, :can_follow?],
                         :fonts_ord => [:user_id, :family_unique_id, :family_name, :family_id, :subfont_name, :subfont_id, :tags_count,
                                        :agrees_count, :pick_status, :img_url, :my_fav?, :expert_tagged] },

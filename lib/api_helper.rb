  ...
  SIGNATURE_MAP =
  {
    ...
    :user_profile   => { :accepts => [[:user_id, :username]],
                         :returns => [:id, :username, :email, :full_name, :description, :website, :url, :url_large, :url_thumb,
                                      ...
                                      :my_photos, :my_friend?],
                         :my_photos => [:id, :user_id, :caption, :created_dt, :url_thumb, :url_large, :username, :user_url_thumb, :permalink,
                                        :likes_count, :fonts_count, :comments_count, :fonts_ord, :address, :latitude, :longitude,
                                        :font_help, :liked?, :commented?, :liked_user, :commented_user, :collections],
                         :collections => [:id, :name, :can_follow?],
                         :fonts_ord => [:user_id, :family_unique_id, :family_name, :family_id, :subfont_name, :subfont_id,
    ...
    :user_photos    => { :accepts => [[:user_id, :page]],
                         :returns => [:id, :user_id, :caption, :created_dt, :url_thumb, :url_large, :username, :user_url_thumb, :permalink,
                                      :likes_count, :fonts_count, :comments_count, :fonts_ord, :address, :latitude, :longitude,
                                      :font_help, :liked?, :commented?, :liked_user, :commented_user, :collections],
                         :collections => [:id, :name, :can_follow?],
                         :fonts_ord => [:user_id, :family_unique_id, :family_name, :family_id, :subfont_name, :subfont_id, :tags_count,

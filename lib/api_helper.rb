...
module ApiHelper
  ...
  SIGNATURE_MAP =
  {
    ...
    :collections         => { :accepts => [],
                              :returns => [:id, :name, :description, :photos_count, :follows_count, :can_follow?] },
    :follow_collection   => { :accepts => [:collection_id],
                              :returns => true },
    :unfollow_collection => { :accepts => [:collection_id],
                              :returns => true },
    :collection_detail   => { :accepts => [:collection_id],
                              :returns => [:id, :name, :description, :photos_count, :follows_count, :can_follow?, :photos],
                              :photos  => [:id, :caption, :user_id, :created_dt, :url_large, :username, :user_url_thumb, :permalink, :likes_count, :fonts_count, :comments_count, :address, :latitude, :longitude] },
    ...
    :photo_detail   => { :accepts => [:photo_id],
                         :returns => [:id, :user_id, :caption, :created_dt, :url_large, :user_url_thumb, :username, :permalink, :likes_count, :fonts_count, :comments_count, :fonts_ord, :address, :latitude, :longitude, :liked?, :commented?, :liked_user, :commented_user, :font_help, :hash_tags, :collection_names],
    ...
    :my_feeds       => { :accepts => [[:page]],
                         :returns => [:id, :user_id, :caption, :created_dt, :url_large, :username, :user_url_thumb, :permalink, :likes_count, :fonts_count, :comments_count, :fonts_ord, :address, :latitude, :longitude, :font_help, :liked?, :commented?, :liked_user, :commented_user, :collection_names],
                         :fonts_ord => [:user_id, :family_unique_id, :family_name, :family_id, :subfont_name, :subfont_id, :tags_count, :agrees_count, :pick_status, :img_url, :my_fav?, :expert_tagged] },

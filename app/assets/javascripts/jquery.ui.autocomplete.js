...
( function($) {
  ...
  $.widget("ui.menu", {
    ...
    refresh : function() {
      ...
      items.addClass("ui-corner-all").attr("tabindex", -1)
      .mouseenter(function(event) {
    ...
    activate : function(event, item) {
      ...
      // this.active = item.eq(0).children("a").addClass("ui-state-hover").attr("id", "ui-active-menuitem").end(); //Commented by Priya
    ...
    deactivate : function() {
      ...
      // this.active.children("a").removeClass("ui-state-hover").removeAttr("id"); //Commented by Priya

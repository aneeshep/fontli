...
User.create!(:username => 'admin', :password => 'P@s$w0rd', :email => 'admin@typestry.com', :admin => true)
...
User.create!(:username => 'guest', :password => 'P@s$w0rd', :email => 'guest@typestry.com', :admin => true)
